...
width = 84
height = 47
Air = Back.LIGHTBLUE_EX + "  " + Back.RESET
Grs = Back.GREEN + "  " + Back.RESET
Drt = Back.YELLOW + "  " + Back.RESET
Stn = Back.LIGHTBLACK_EX + "  " + Back.RESET
Bdr = Back.WHITE + "  " + Back.RESET
Leaf = Back.LIGHTGREEN_EX + "  " + Back.RESET
Logg = Back.LIGHTYELLOW_EX + "  " + Back.RESET
Aire = Air
I_ore = Back.WHITE + "  " + Back.RESET
L_ore = Back.BLUE + "  " + Back.RESET
...
subprocess.Popen(['xterm', '-e', 'python3', '-c', 'print("Hello world!")'])
while True:
...
Air = api.block("Air",True,False,None,None)
Emt = api.block("Emt",True,False,None,None)
Drt = api.block("Drt",False,True,1,"dirt")
Plr = api.player()

a = [Air, Air, Air, Air, Air]
b = [Air, Air, Air, Air, Air]
c = [Air, Drt, Plr, Air, Air]
d = [Emt, Emt, Emt, Emt, Emt]
space = [a,b,c,d]
